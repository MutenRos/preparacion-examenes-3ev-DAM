...
<html>
	...
	<body>
		...
		<p>Correo</p>
		<input type="text" placeholder="Indica tu correo electrónico">
		<p>Nombre y Apellidos</p>
		<input type="text" placeholder="Indica tu nombre y tus apellidos">
		<p>Teléfono</p>
		<input type="text" placeholder="Indica tu teléfono">
		<p>Curso en el que estás interesado/a</p>
		<input type="text" placeholder="Curso en el que estás interesado/a">
		<?php
