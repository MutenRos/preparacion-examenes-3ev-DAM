...
(() => {
  ...
  function startAvatarIdle() {
    ...
    function animate() {
      ...
      const rotX = Math.sin(t * 0.8) * 4;
      const rotY = Math.sin(t * 1.1) * 5;
      const rotZ = Math.sin(t * 0.6) * 3;
  ...
  // Wait a moment so A-Frame builds entities
  window.addEventListener("load", () => setTimeout(startAvatarIdle, 200));
