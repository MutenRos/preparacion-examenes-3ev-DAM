...
function rotatePointLikeWorld(x, y, z) {
    ...
    // CSS aplica primero rotateY y después rotateX
...
function updateBillboards() {
    ...
    cells.forEach(cell => {
        ...
        // Aplicar opacidad al contenedor, no al círculo escalado
