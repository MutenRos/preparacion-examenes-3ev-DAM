#!/usr/bin/env python3
"""Genera post.md en cada uno de los 37 proyectos de la 3ª evaluación.

Sigue la rúbrica de evaluación de jocarsa (4 apartados al 25%):
  - Introducción y contextualización
  - Desarrollo detallado y preciso
  - Aplicación práctica
  - Conclusión breve

Formato divulgativo: gancho inicial, primera persona, párrafos cortos y
hashtags al final, manteniendo los 4 apartados de la rúbrica."""
